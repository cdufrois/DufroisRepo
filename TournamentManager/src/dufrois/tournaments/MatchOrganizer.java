...
import dufrois.common.Match;
import dufrois.common.SportTypeEnum;
import dufrois.common.Team;
import dufrois.pingpong.PingPongMatch;
...
public class MatchOrganizer
{
	...
	public boolean initPingPongMatch(PingPongTeam t1, PingPongTeam t2, boolean edit, boolean initial, int win,
			int serve, boolean two)
	{
		if (sport != SportTypeEnum.PINGPONG)
		{
			return false;
