...
import dufrois.gui.tourntypes.SingleMatchPanel;
...
public class HomePanel extends JPanel
{
    ...
    public HomePanel(JFrame f)
    {
        ...
        butt.setBounds(800, WindowVars.HEIGHT - WindowVars.NONUSABLE_HEIGHT, WindowVars.BUTTON_WIDTH, WindowVars.BUTTON_HEIGHT);
        add(butt);
    ...
    public class CreateNewTournament implements ActionListener
    {
        public void actionPerformed(ActionEvent arg0)
        {
            ...
            switch (tournType)
            {// Should be doing stuff through the tourn type and passing in game type
            case MATCH:
