...
public class WindowVars
{
    ...
    /*
    public static int getCenterXValue()
    {
        return (WindowVars.WIDTH - WindowVars.NONUSABLE_WIDTH) / 2;
    }
    
    public static int getCenterYValue()
    {
        return (WindowVars.HEIGHT - WindowVars.NONUSABLE_HEIGHT) / 2;
    }
    */
}
