package dufrois.gui.createteam;
...
import dufrois.gui.tourntypes.ReceiveTeamInterface;
...
public class CreatePPTeamPanel extends JPanel
{
    ...
    private ReceiveTeamInterface teamReceiver;
    private PingPongTeam team;
    private boolean isTeamOne;
    private int width, height;
    
    public CreatePPTeamPanel(ReceiveTeamInterface rec, PingPongTeam t, boolean one, int w, int h)
    {
        /*
